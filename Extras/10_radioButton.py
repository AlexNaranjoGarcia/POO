...
def mostrar_seleccion():
    resultado.config(text=f"Has seleccionado: {opcion.get()}")
...
opcion=StringVar()
opcion1 = Radiobutton(ventana, text="Opción 1", value="opcion1", variable=opcion)
opcion1.pack()
opcion2 = Radiobutton(ventana, text="Opción 2", value="opcion2", variable=opcion)
opcion2.pack()
opcion3 = Radiobutton(ventana, text="Opción 3", value="opcion3", variable=opcion)
opcion3.pack()

boton = Button(ventana, text="Mostrar selección", command="")
boton.pack()
